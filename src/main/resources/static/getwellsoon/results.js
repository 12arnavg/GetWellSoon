var givenCondition = window.localStorage.getItem("givenCondition");
var givenGender = window.localStorage.getItem("givenGender");
var givenAge = window.localStorage.getItem("givenAge");
var givenLocation = window.localStorage.getItem("givenLocation");
var resCondition = encodeURIComponent(givenCondition);
var resGender = encodeURIComponent(givenGender);
var resAge = encodeURIComponent(givenAge);
var resLocation = encodeURIComponent(givenLocation);
